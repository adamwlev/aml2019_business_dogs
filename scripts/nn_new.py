...
def get_pic_mats(n_components):
    pics_train = np.load('pics_train_full_wbert.npy')
    pics_test = np.load('pics_test_full_wbert.npy')
...
if __name__=="__main__":
    ...
    text_train = np.load('text_train_full_wbert.npy')
    text_test = np.load('text_test_full_wbert.npy')
